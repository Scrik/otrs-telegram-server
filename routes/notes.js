...
router.get('/:id', function(req, res, next) {
    ...
    OTRS.getTicket(data.TicketID).then((Ticket) => {
        ...
        if(Ticket.Article[0].FromRealname != "Telegram BOT"){
            request.get(`https://api.telegram.org/bot445113487:AAE8FET984QpOTsLIqEMZTMpRH2NUkAO6v4/sendMessage?chat_id=${data.telegram.chatID}&text=${encodeURIComponent(data.telegram.message)}`,(err,res,body) => {
